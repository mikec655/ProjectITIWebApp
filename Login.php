<html>
    ...
    <body> 
        <div class="filler"></div>
            <div class="container">
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off"><link rel="stylesheet" type="text/css" href="youri.css">
                        <ul class="loginstyling">    
                            <img src="">
                            <br>
                            <p>Welkom op Sonimod hier kunt u inloggen.<p>
